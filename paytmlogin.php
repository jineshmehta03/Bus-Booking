...

{
...

    {
     ...
     echo "<script>
     alert('Your are Logged In to Book buses from Paytm')
 
 
     window.location='https://paytm.com/bus-tickets';
...
<form  method="POST">
      ...
      <div class="modal-footer">
        <input  type="submit" class="btn btn-primary" name="ptmlogin" value="Login To Paytm">
      </div>
    </div>
